import { Users, TrendingUp, ListChecks } from "lucide-react";
import { Card, CardContent } from "../ui/card";
import { Skeleton } from "../ui/skeleton";
import type { PlanningsKPIs } from "../shared/schema";

interface KPICardsProps {
  data?: PlanningsKPIs[];
  isLoading: boolean;
  filters?: any; // Ajouté pour les filtres
  onClearDates?: () => void;   
}

export default function PlanningsKPICards({ data, isLoading }: KPICardsProps) {
